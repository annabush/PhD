...
reg_summary <- function(model, model.name, response.var, out.file, digits=3){
...
reg_summary(m4h, "LMM4h", "error", "C:/Users/anna-/OneDrive - University of Exeter/ANNA PhD WRITE-UP/7. Artefacts - edge effects/Tables/results.csv")

...
working.directory <- paste(dirname(rstudioapi::getActiveDocumentContext()$path), "pi errors and precisions", sep="/")
...
plot1 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.pi)) +
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.095, 0.095), name = "Error \nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
...
#absolute
plot2 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.pi)) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.5))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp")+
  facet_grid(pi2 ~ prior.precision)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.095), name = "Absolute Error \nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
#plotting accuracy
#not absolute
plot4 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.078, 0.078), name = "Error \nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
#absolute
plot5 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp")+
  facet_grid(pi2 ~ constraint)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.085), name = "Absolute Error \nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot7 <- ggplot(results[which(results$prior.distribution != "Normal"),], aes(se1, sp1, z=error) ) +
  ...
  ylab("True Sp")+
  facet_grid(pi2 ~ constraint)+
  scale_fill_gradientn(colours = nonabs, limits=c(-0.39, 0.39), name = "Error \nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
#absolute
plot8 <- ggplot(results[which(results$prior.distribution != "Normal"),], aes(se1, sp1, z=error5.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp")+
  facet_grid(pi2 ~ constraint)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.58), name = "Absolute Error \nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot9 <- ggplot(results[which(results$prior.distribution != "Normal"),], aes(se1, sp1, z=sd.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
plot10 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.075, 0.075), name = "Error \nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
ggsave(filename="plot_10.png", plot=plot10, width=5.9)

plot11 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
plot12 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=sd.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
#plotting accuracy
#not absoluted
plot13 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.21, 0.21), name = "Error \nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
#absolute
plot14 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp")+
  facet_grid(pi2 ~ n.tests)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.21), name = "Absolute Error \nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot15 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=sd.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  scale_fill_gradientn(colours = prec, name = "Standard Deviation\nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot16 <- ggplot(results[which(results$prior.precision != "Precise"),], aes(se1, sp1, z=error.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.33, 0.33), name = "Error \nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot17 <- ggplot(results[which(results$prior.precision != "Precise"),], aes(se1, sp1, z=error5.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp")+
  facet_grid(pi2 ~ prior.distribution)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.33), name = "Absolute Error \nof Pi prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot18 <- ggplot(results[which(results$prior.precision != "Precise"),], aes(se1, sp1, z=sd.pi) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+

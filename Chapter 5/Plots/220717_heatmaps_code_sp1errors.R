...
working.directory <- paste(dirname(rstudioapi::getActiveDocumentContext()$path), "sp1 errors and precisions", sep="/")
...
#non absolute
plot1 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.sp1)) +
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.04, 0.04), name = "Error \nof Sp1 prediction", labels = function(x) sprintf("%.2f", x))+
...
#absolute
plot2 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.sp1)) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.5))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ prior.precision)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.05), name = "Absolute Error \nof Sp1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot3 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=sd.sp1)) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.5))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+ 
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ prior.precision)+
  scale_fill_gradientn(colours = prec, name = "Standard Deviation \nof Sp1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
#plotting accuracy
#not absolute
plot4 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
...
#absolute
plot5 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ constraint)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.04), name = "Absolute Error \nof Sp1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot6 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=sd.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
#plotting accuracy
#not absolute
plot7 <- ggplot(results[which(results$prior.distribution != "Normal"),], aes(se1, sp1, z=error.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ constraint)+
  scale_fill_gradientn(colours = nonabs, limits=c(-0.7, 0.7), name = "Error \nof Sp1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
#absolute
plot8 <- ggplot(results[which(results$prior.distribution != "Normal"),], aes(se1, sp1, z=error5.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ constraint)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.7), name = "Absolute Error \nof Sp1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot9 <- ggplot(results[which(results$prior.distribution != "Normal"),], aes(se1, sp1, z=sd.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
plot10 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.036, 0.036), name = "Error of \nSp1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
ggsave(filename="plot_10.png", plot=plot10, width=5.9)

plot11 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
plot12 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=sd.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
#plotting accuracy
#not absoluted
plot13 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.08, 0.08), name = "Error \nof Sp1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
#absolute
plot14 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ n.tests)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.075), name = "Absolute Error \nof Sp1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot15 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=sd.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ n.tests)+
  scale_fill_gradientn(colours = prec, limits=c(0,0.07), name = "Standard Deviation \nof Sp1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot16 <- ggplot(results[which(results$prior.precision != "Precise"),], aes(se1, sp1, z=error.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.34, 0.34), name = "Error \nof Sp1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot17 <- ggplot(results[which(results$prior.precision != "Precise"),], aes(se1, sp1, z=error5.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ prior.distribution)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.34), name = "Absolute Error \nof Sp1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot18 <- ggplot(results[which(results$prior.precision != "Precise"),], aes(se1, sp1, z=sd.sp1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+

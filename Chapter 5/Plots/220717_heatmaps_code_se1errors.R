...
working.directory <- paste(dirname(rstudioapi::getActiveDocumentContext()$path), "se1 errors and precisions", sep="/")
...
#non absolute
plot1 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.se1)) +
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.11, 0.11), name = "Error \nof Se1 prediction", labels = function(x) sprintf("%.2f", x))+
...
#absolute
plot2 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.se1)) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.5))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ prior.precision)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.11), name = "Absolute Error \nof Se1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot3 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=sd.se1)) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.5))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+ 
...
#plotting accuracy
#not absolute
plot4 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
...
#absolute
plot5 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ constraint)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.08), name = "Absolute Error \nof Se1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot6 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=sd.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
#plotting accuracy
#not absolute
plot7 <- ggplot(results[which(results$prior.distribution != "Normal"),], aes(se1, sp1, z=error.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
#absolute
plot8 <- ggplot(results[which(results$prior.distribution != "Normal"),], aes(se1, sp1, z=error5.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ constraint)+
  scale_fill_gradientn(colours = abso, limits=c(0,0.8), name = "Absolute Error \nof Se1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot9 <- ggplot(results[which(results$prior.distribution != "Normal"),], aes(se1, sp1, z=sd.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
plot10 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
plot11 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
plot12 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=sd.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
#plotting accuracy
#not absoluted
plot13 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.1, 0.1), name = "Error \nof Se1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
#absolute
plot14 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=error5.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ n.tests)+
  scale_fill_gradientn(colours = abso, limits=c(0, 0.1), name = "Absolute Error \nof Se1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot15 <- ggplot(results[which(results$prior.distribution != "Uniform"),], aes(se1, sp1, z=sd.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
...
plot16 <- ggplot(results[which(results$prior.precision != "Precise"),], aes(se1, sp1, z=error.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
  ...
  scale_fill_gradientn(colours = nonabs, limits=c(-0.48, 0.48), name = "Error \nof Se1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
ggsave(filename="plot_16.png", plot=plot16, width=5.9)

plot17 <- ggplot(results[which(results$prior.precision != "Precise"),], aes(se1, sp1, z=error5.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5)) +
  ...
  ylab("True Sp1")+
  facet_grid(pi2 ~ prior.distribution) +
  scale_fill_gradientn(colours = abso, limits=c(0, 0.5), name = "Absolute Error \nof Se1 prediction", labels = function(x) sprintf("%.2f", x))+
  theme(panel.border = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank())+
  theme(plot.margin=grid::unit(c(0,0,0,0), "mm"))
...
plot18 <- ggplot(results[which(results$prior.precision != "Precise"),], aes(se1, sp1, z=sd.se1) ) +
  geom_tile(colour = "white", binwidth=0.5/5, stat = "summary2d")+
  coord_fixed()+
  scale_y_continuous(breaks = seq(0.5, 1, 0.1))+
  scale_x_continuous(breaks = seq(0, 1, 0.5))+
